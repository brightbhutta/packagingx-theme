		...
		<div class="container">
			<div class="row">
				<div class="col-lg-7 col-sm-12 col-md-12 col-xs-12">
					<div class="cat-slide">
						<h1>Custom  CBD Box Packaging</h1>
						<p>Whether you want CBD tincture boxes, hemp oil boxes, e-liquid boxes, vape cartridge boxes, we will manufacture it for you. Simply put, whatever your product is we will produce the custom boxes for you according to the dimensions and shape you want.</p>
					</div>
				</div>
