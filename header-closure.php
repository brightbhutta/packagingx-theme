		...
		<div class="container">
			<div class="row">
				<div class="col-lg-5 col-sm-12 col-md-12 col-xs-12">
					<div class="cat-slide">
						<h1>Make an impression with our Bottom Closure Boxes</h1>
						<p>We can create 1-2-3 Bottom, Auto Bottom with Display Lid, Full Flap Auto Bottom, or Seal End Auto Bottom Boxes. We make custom boxes for your products in the dimensions and shapes you choose.</p>
					</div>
				</div>
