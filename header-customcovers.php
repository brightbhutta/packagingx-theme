		...
		<div class="container">
			<div class="row">
				<div class="col-lg-5 col-sm-12 col-md-12 col-xs-12">
					<div class="cat-slide">
						<h1>Custom CD Covers</h1>
						<p>CDs are a valuable and memorable asset of every person. Whether it is a game, movie, pictures, office data, or any software; CDs are the best way to store them effectively. No one will like to spoil his/her huge collection.</p>
					</div>
				</div>
