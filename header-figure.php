		...
		<div class="container">
			<div class="row">
				<div class="col-lg-5 col-sm-12 col-md-12 col-xs-12">
					<div class="cat-slide">
						<h1>Add Care Through Custom Figure & Pattern Boxes</h1>
						<p>Whether you want Double Wall Tuck Top, Four Corner with Display Lid, Gable Bag Auto Bottom, Gable Bag Bottom Hange or Self Lock Cake Box we will manufacture it for you. Simply put, whatever your product is we will produce the custom boxes for you according to the dimensions and shape you want.</p>
					</div>
				</div>
