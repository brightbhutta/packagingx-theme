...
<div class="wrapper">
	...
	if ( !empty( $image ) ) { ?>
	<section id="food" style="background-image:url('<?php echo $image['url']; ?>');" >
		<?php } ?>
		<div class="container">
			<div class="row">
				<div class="col-lg-7 col-sm-12 col-md-12 col-xs-12">
					<div class="cat-slide">
						<h1>Make your Meals Better with Custom Food Packaging</h1>
						<p>Food packing boxes that are meant to retain your items securely and boost your hunger. At PackagingX our high-quality custom printing boxes will improve your whole dining experience.</p>
					</div>
				</div>
				<div class="col-lg-12 col-md-12 col-xs-12">
                    <div class="trusted">
                        <h2>Trusted by 1,000s Of Happy Customers</h2>
                        <img src="https://packagingx.com/wp-content/uploads/2021/12/Knor-2.svg"  alt="trusted" />
