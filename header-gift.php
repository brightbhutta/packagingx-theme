		...
		<div class="container">
			<div class="row">
				<div class="col-lg-7 col-sm-12 col-md-12 col-xs-12">
					<div class="cat-slide">
						<h1>Select it. Wrap it. Gift it. with our Custom Gift Packaging</h1>
						<p>Thinking in putting together a special gift to make your loved ones feel passionate and full of joy?  With our custom printed gift boxes, Give your loved ones beautiful gifts and feelings.</p>
					</div>
				</div>
				<div class="col-lg-12 col-md-12 col-xs-12">
                    <div class="trusted">
