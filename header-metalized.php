		...
		<div class="container">
			<div class="row">
				<div class="col-lg-7 col-sm-12 col-md-12 col-xs-12">
					<div class="cat-slide">
						<h1>Enhance the Beauty of your Product with our Custom Metalized Packaging</h1>
						<p>Customized Metalized Boxes that will definitely enhance the beauty of your product and help out in standing out in the market ensuring packaging with finishing and sturdy look at reasonable price. </p>
					</div>
				</div>
				<div class="col-lg-12 col-md-12 col-xs-12">
                    <div class="trusted">
