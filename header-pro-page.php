    ...
    <div class="container">
        <div class="row">
			<div class="col-lg-5 col-sm-12 col-md-12 col-xs-12">
				<div class="cat-slide">
					<h1>Get the Most Definitely with our Fold and Assemble Boxes</h1>
					<p>Whether you want Bookend, Double Wall Tuck Front, Four Corner Cake Box, Gable Box Auto Bottom, Hexagon, Hexagon 2 PC, Tray and Sleeve Box or Two Piece Boxes we will manufacture it for you. Simply put, whatever your product is we will produce the custom boxes for you according to the dimensions and shape you want.</p>
				</div>
			</div>
