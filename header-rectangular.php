		...
		<div class="container">
			<div class="row">
				<div class="col-lg-5 col-sm-12 col-md-12 col-xs-12">
					<div class="cat-slide">
						<h1>Add Feelings to your Products with our Custom Rectangular Boxes</h1>
						<p>Whether you want Dispenser, Four Corner Tray, Reverse Tuck End, Seal End, Straight Tuck End or Tuck End Auto Bottom Boxes we will manufacture it for you. Simply put, whatever your product is we will produce the custom boxes for you according to the dimensions and shape you want.</p>
					</div>
				</div>
