			...
			<div class="row">
				<div class="col-lg-7 col-sm-12 col-md-12 col-xs-12">
					<div class="cat-slide">
						...
						<p>From custom product boxes on shelves to personalized or custom cardboard boxes, We can help you in creating an experience that your consumers will like when they enter the store or when they leave with a product in hand.</p>
					</div>
				</div>
					<div class="trusted">
