		...
		<div class="container">
			<div class="row">
				<div class="col-lg-5 col-sm-12 col-md-12 col-xs-12">
					<div class="cat-slide">
						<h1>Make your product more confident with our showcase exhibit boxes</h1>
						<p>Whether you want bottom Display Lid, Double Wall with Display Lid, Five Panel Hanger or Paper Brief case we will manufacture it for you. Simply put, whatever your product is we will produce the custom boxes for you according to the dimensions and shape you want.</p>
					</div>
				</div>
