<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
    <div class="product_heading">
        <h2>Metalized Boxes</h2>
    </div>
</div>
<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
    <div class="product_heading">
        <a href="/metalized-boxes/">View All Products</a>
    </div>
</div>
<div class="carousel-wrapper">
    <div class="owl-carousel owl-theme" id="metalizedcarousels">
    <?php
        $args = array(
           'posts_per_page' => 3,
           'post_type'      => 'product', 
...
<script type="text/javascript">
    $('#metalizedcarousels').owlCarousel({
      loop: true,
      margin: 10,
      nav: true,
      dots: false,
