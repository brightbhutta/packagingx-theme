<?php /* Template Name:Category Page Gift Boxes */ ?>
<?php get_header('gift'); ?>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">
                    <div class="cbd-heading">
                        <h2>Explore Popular Custom Gift Boxes</h2>
                    </div>
                </div>
            </div>
                    <div class="row">
                     ...
                     $args = array(
                           ...
                           'tax_query' => array(
                                        array(
                                            ...
                                            'terms'    => 'gift-boxes' //if field is ID you can reference by cat/term number
                                        )
                                    ),
                           'paged'          => $paged
                         ); 
            ...
            <div class="row" id="delivered">
                <div class="col-lg-6 col-md-12 col-xs-12">
                    <div class="del">
                        <img src="https://packagingx.com/wp-content/uploads/2021/12/Gift-Boxes-1.jpg" alt="Custom Gift Boxes" />
                    </div>
                </div>
                <div class="col-lg-6 col-md-12 col-xs-12">
                    <div class="del-txt">
                        <h5>Sealed with love and patience..</h5>
                        <h2>Why use custom gift boxes.?</h2>
                        <p>Custom gift boxes are a great way to personalize your gifts to your cherished one and make a lasting impression. You can choose from our wide selection of styles, in various measurements and forms. Additionally, gift boxes are an excellent way to send delicate products and accessories to your customers and loved ones.</p>
                        <p>Packaging X provides you the solution for the best packaging solution. Our graphic designers will leave no stone unturned in their efforts to make your packaging a market success.</p>
           ...
           <?php include('packaking.php'); ?>
            <div class="row" id="product-txt">
                <div class="col-lg-3 col-md-6 col-xs-12">
                    <div class="cbd-txt">
                        <h3>Find Premium Quality of <a href="https://packagingx.com/">Custom Gift Boxes</a> for your Products at PackagingX.</h3>
                    </div>
                </div>
                <div class="col-lg-6 col-md-12 col-xs-12">
                    <div class="cbd-txt-image">
                        <img src="https://packagingx.com/wp-content/uploads/2021/12/Gift-Boxes-2-1.jpg"  alt="Gift Boxes Wholesale" />
                    </div>
                </div>
				<div class="col-lg-3 col-md-6 col-xs-12">
                    <div class="cbd-txt">
						<p>You have the authority to customize the gift box according to your preference and choice at PackagingX. We at PackagingX prioritise your convenience and ease at top, so you will receive your order in 6-7 business days at your doorstep. In addition, we ensure to provide the best quality material for your product as well.</p>
                        <p>Whenever you want to add additional value to your products, our high-end custom printed boxes are a great option to consider. The order will be delivered immediately in the event of an emergency.</p>
