        ...
        <div class="container">
            <div class="row">
                 <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">
                    <div class="cbd-heading">
                        <h2>Explore Custom Metalized Boxes</h2>
                    </div>
                </div>
            </div>
                    <div class="row">
                     ...
                     $args = array(
                           ...
                           'tax_query' => array(
                                        array(
                                            ...
                                            'terms'    => 'metalized-boxes' //if field is ID you can reference by cat/term number
                                        )
                                    ),
                           'paged'          => $paged
                         ); 
            ...
            <div class="row" id="delivered">
                <div class="col-lg-6 col-md-12 col-xs-12">
                    <div class="del">
                        <img src="/wp-content/uploads/2022/01/Metalized-Box-image-1.jpg" alt="Custom Metalized Boxes" />
                    </div>
                </div>
                <div class="col-lg-6 col-md-12 col-xs-12">
                    <div class="del-txt">
                        <h5>Delivered with care.</h5>
                        <h2>Why use Custom Meatlized Boxes.?</h2>
						<p>Metalized packaging boxes are an excellent marketing tool for your company if you sell high-end goods and want to lure potential customers in and entice them to make a purchase. You have the option of personalizing the boxes to suit your tastes.</p> 
                        <p>Depending on your needs, you can adjust the width and length of your boxes. Having a metalized box will make your product appear more expensive and luxurious to your customers. So, hurry up and contact our team via email or call and grab your favorite metalized boxes.</p>
           ...
           <?php include('packaking.php'); ?>
            <div class="row" id="product-txt">
                <div class="col-lg-3 col-md-6 col-xs-12">
                    <div class="cbd-txt">
                        <h3>Find Premium Quality of <a href="https://packagingx.com/">Custom Metalized Boxes</a> for your Products at PackagingX.</h3>
                    </div>
                </div>
                <div class="col-lg-6 col-md-12 col-xs-12">
                    <div class="cbd-txt-image">
                        <img src="https://packagingx.com/wp-content/uploads/2021/12/Metalized-Box-2.jpg"  alt="Metalized Boxes" />
                    </div>
                </div>
 				<div class="col-lg-3 col-md-6 col-xs-12">
                    <div class="cbd-txt">
                        <p>PackagingX is introducing customized metalized boxes that will definitely enhance the beauty of your product and will help out in standing out in the market. All you need is to choose the color, size and shape, and our design team will create a unique masterpiece for your product. We ensure packaging with finishing and sturdy look at a reasonable price.</p>
                        <p>Orders can range from 100 boxes up to 500,000. You can expect your order to arrive within 6-8 business days of placing it.</p>
                        <p>The order will be delivered immediately in the event of an emergency.</p>
