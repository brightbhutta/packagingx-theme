				...
				<div class="col-lg-8 col-md-12">
					<div class="contact-form">
						<form method="POST" action="#"> 
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
						                ...
						                <input class="form-control" type="text" name="Firstname" placeholder="Type your First Name"/>
								...
								<div class="col-md-6">
									<div class="form-group">
						                ...
						                <input class="form-control" type="text" name="Lastname" placeholder="Type your Last Name"/>
						                <span class="Error"></span>
				            		</div>
								</div>
							</div>
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
						                ...
						                <input class="form-control" type="text" name="email" placeholder="Type your Email Address"/>
						                <span class="Error"></span>
				            		</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
						                ...
						                <input class="form-control" type="text" name="Lastname" placeholder="Your Number"/>
						                <span class="Error"></span>
				            		</div>
								</div>
							</div>
							<div class="row">
								<div class="col-md-3">
									<div class="form-group">
						                ...
						                <input class="form-control" type="text" name="quantity" placeholder="Enter your Quantity"/>
						                <span class="Error"></span>
				            		</div>
								</div>
								<div class="col-md-3">
									<div class="form-group">
						                ...
						                <input class="form-control" type="text" name="quantity1" placeholder="Enter your Quantity"/>
						                <span class="Error"></span>
				            		</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
						                ...
						                <select class="form-control form-select selectpicker show-tick">
													<option value="">---</option>
							...
							<div class="row">
								<div class="col-md-12">
									<div class="form-group">
						                <label>Please describe your requirement. *</label>
						                <textarea rows="5" placeholder="Let us know what you need! Box dimensions, number of boxes you need, design, a link to download your reference images? – we can help."></textarea>
						            </div>
								</div>
							</div>
							<div class="row">
								<div class="col-md-12">
									<div class="form-group">
										<input class="btn btn-primary" id="send" type="button" value="Submit" />
									</div>
								</div>
							</div>
						</form>
				   ...
				   <div class="col-lg-12 col-md-12">
					  <div class="call-us">
						...
						<a href="tel:(440)-271-2726">Call Us</a>
					 </div>
				   </div>
				</div>
			</div>
