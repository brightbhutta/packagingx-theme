            ...
            <div class="row">
                <div class="col-lg-7 col-md-12">
                    ...
                    <div class="single-gallery">
                        <h2><?php the_title(); ?></h2>  
                        <div class="row">
                            <div class="col-lg-3 col-md-6 bhoechie-tab-menu">
                            ...
                            <div class="col-lg-9 col-md-6 bhoechie-tab">
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                              <div class="accordion-body">
                                <p>After the order is confirmed our customer sales representative will send you the tracking ID of the realtive shipment and delivery service. By which you can track the order by going to there website easily.</p>
                              </div>
                            </div>
                        </div>
                        <div class="accordion-item">
