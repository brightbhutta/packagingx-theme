                ...
                <div class="col-lg-5 col-md-12">
                    <div class="product-form">
                        ...
                        <?php while( have_posts() ): the_post(); ?>
                            <h1><?php the_title(); ?></h1>
                        <?php endwhile; ?>
						<p>The form, colour, size, design, and finishing of these boxes are all completely customizable.</p>
                        ...
                        <form method="POST" action="" id="login" onsubmit="process(event)" enctype="multipart/form-data">
                            <div class="row">
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12">
                                    <div class="form-group">
                                        <input type="submit" id="product_form" class="btn btn-rounded btn-primary" name="submit" value="Send" />
                                    </div>
                                </div>
                            </div>
                        </form>
    ...
    <section id="relatedproducts">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="related">
                        <h2>People Who Bought <?php the_title(); ?>  Also Bought</h2>
                    </div>
                </div>
                <?php
            ...
            <div class="row" id="sub-form">
                <div class="col-lg-6 col-md-12">
                    <div class="subscribe">
                        ...
                        <h3>Subscribe for promotions, special offers and news from the <i>packaging industry.</i></h3>
